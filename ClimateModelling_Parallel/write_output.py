...
def write_parallel(abs_files, ens_means, analysis_str, variables, end_date, argv,
                               saved, full_saved, lon_centre, mask, lon, lat,
                                grid, mean_folder, start_end_str, tup_ens):
...
def write_means_to_netcdf_file(ens_files, abs_files, ens_means, analysis_str, variables, start_date, end_date, argv,
    ...
    if total:
        ...
        func = partial(write_parallel, abs_files, ens_means, analysis_str, variables, end_date, argv,
                                   saved, full_saved, lon_centre, mask, lon, lat,
